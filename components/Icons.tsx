...
export function FacebookIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M14 8.5V7c0-.8.2-1.2 1.4-1.2H17V3h-2.4C11.9 3 11 4.3 11 6.6v1.9H9V11h2v10h3V11h2.2l.3-2.5H14Z" />
    </svg>
  );
}
...
export function TwitterIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M17.7 3h3.3l-7.2 8.2L22 21h-6.6l-5.2-6.8L4.2 21H.9l7.7-8.8L.7 3h6.8l4.7 6.2L17.7 3Zm-1.2 16h1.8L7.6 4.8H5.7L16.5 19Z" />
    </svg>
  );
}
