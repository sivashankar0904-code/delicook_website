...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Mix Veg Curry',
    description:
      'A mixed vegetable curry base with everyday South Indian seasoning. Add your vegetables and it comes together in one pan.',
    category: 'ready-to-cook',
  },
  {
    slug: 'poondu-kulambu',
  ...
  // ---- Ready To Eat --------------------------------------------------------
  {
    slug: 'tiffin-tomato-sambar',
    name: 'Tiffin Tomato Sambar',
    description:
      'The lighter, tomato-led sambar served alongside idli and dosa. Fully cooked — heat and pour.',
    category: 'ready-to-eat',
  },
  {
    slug: 'ground-nut-chutney',
    name: 'Ground Nut Chutney',
    localName: 'Peanut Chutney',
    description:
      'Roasted peanuts ground with chillies and tempered with curry leaves. Ready to serve with any tiffin.',
    category: 'ready-to-eat',
  },
  {
    slug: 'kambu-kool',
